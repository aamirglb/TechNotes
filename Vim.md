...
* The behaviour of `p` and `P` depends on whether you have yanked characters or line. If you've yanked _characters_ then pasting will put those characters after or before the cursor. If you've yanked lines, however, pasting will put those lines after or before the line where the cursor is resting on.
